...
<form id="login" action="index.php" method="POST">
    ...
    <table class="tabNonQuadrille">
        ...
        <tr class="ligneTabNonQuad">
            ...
            <td class="inpForm"><input id="nom" name="nom" type="text" size="20" required><div></div></td>
        </tr>
        <tr class="ligneTabNonQuad">
            <td><span>Nom du responsable : </span></td>
            <td class="inpForm"><input id="identiteResponsable" name="identiteResponsable" type="text" pattern="^[a-zA-ZáàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ'\s\-]+$" size="20"><div></div></td>
        </tr>
        <tr class="ligneTabNonQuad">
            <td><span>Adresse postale : </span></td>
            <td class="inpForm"><input id="adressePostale" name="adressePostale" type="text" size="20"><div></div></td>
        </tr>
        <tr class="ligneTabNonQuad">
            <td><span>Nombre de personnes : </span></td>
            <td class="inpForm"><input id="nombrePersonnes" name="nombrePersonnes" type="number" value="1" min="1" size="20" required><div></div></td>
        </tr>
        <tr class="ligneTabNonQuad">
        ...
        <tr class="ligneTabNonQuad">
            ...
            <td>
                <input type="radio" name="hebergement" value="O" checked> Oui
                <input type="radio" name="hebergement" value="N"> Non
            </td>
        </tr>
        <tr class="ligneTabNonQuad">
            <td><span>Identifiant : </span></td>
            <td class="inpForm"><input id="login" name="login" type="text" size="20" required><div></div></td>
        </tr>
        <tr class="ligneTabNonQuad">
        ...
        <tr class="ligneTabNonQuad">
            ...
            <td class="inpForm"><input id="repassword" name="repassword" type="password" size="20" required><div></div></td>
        </tr>
    </table>
